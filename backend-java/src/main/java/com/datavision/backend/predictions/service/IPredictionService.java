...
public interface IPredictionService {
    ...
    byte[] predictWithCsvFile(Long projectId, String modelName, MultipartFile file, boolean returnProbabilities, User user);
    ...
    byte[] predictWithCsvFilePipeline(Long projectId, String pipelineName, MultipartFile file, boolean returnProbabilities, User user);
