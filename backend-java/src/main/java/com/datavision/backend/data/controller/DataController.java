...
public class DataController {
    ...
    public ResponseEntity<ApiResponse> uploadMultipartFile(@PathVariable Long projectId,
            @RequestPart @NotNull(message = "Cannot upload - file is not present") MultipartFile file) {
    ...
    public ResponseEntity<Object> analyzeData(@PathVariable Long projectId,
            @RequestParam(required = false, defaultValue = "false") boolean useScaled) {
    ...
    public ResponseEntity<Object> correlationData(@PathVariable Long projectId, @RequestParam @NotBlank String target,
            @RequestParam(required = false, defaultValue = "false") boolean useScaled) {
    ...
    public ResponseEntity<Object> cleanScaleData(@PathVariable Long projectId,
            @RequestBody @Valid CleanDataRequest request) {
